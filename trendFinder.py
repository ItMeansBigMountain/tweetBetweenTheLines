...
# MENU TO CHOOSE COUNTRY
def fetch_area_topics(api):
    availabe_countries = api.available_trends()
    ...
    # DEBUG
    print("Chicago: 2379574")
    print("New York: 2459115")
    print("Dallas: 2388929")
    print("Toronto: 4118")
    print("México: 133480")
    print("San Francisco: 2487956")
...
# world =  fetch_global(api)
Specific_area_top_topics =  fetch_area_topics(api)
pprint( Specific_area_top_topics )